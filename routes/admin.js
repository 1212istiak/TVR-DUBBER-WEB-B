...
// There's no session/token here — this just tells the frontend "yes, that
// password is correct" so it can show the admin panel and remember the
// password locally. Every subsequent admin request re-checks the password
// itself via requireAdmin.
...
// GET /api/admin/comments?password=... — all comments, grouped by episode
...
// DELETE /api/admin/comments/:id  { password }
